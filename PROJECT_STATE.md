...
`otp_fraud`, `online_impersonation`, `phishing`, `identity_theft` (4/14).
...
**Immediate Next Task:** User reviews the `identity_theft` population, then instructs
the next issue (suggested next: `unauthorized_account_access` — requires new IT Act
sections 43 and 66 as pending-verification candidates).
